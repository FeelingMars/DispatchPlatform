...
namespace DB_TeleBill.BLL 
{
	...
	{    
		private readonly DB_TeleBill.DAL.m_RoleAuthority dal=new DB_TeleBill.DAL.m_RoleAuthority();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_TeleBill.Model.m_RoleAuthority model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_TeleBill.Model.m_RoleAuthority model)
		{
			return Update(model,"");
		}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_TeleBill.Model.m_RoleAuthority> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_TeleBill.Model.m_RoleAuthority> GetModelListSql(string strSql)
        {
