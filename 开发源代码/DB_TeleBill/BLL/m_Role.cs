...
namespace DB_TeleBill.BLL 
{
	...
	{    
		private readonly DB_TeleBill.DAL.m_Role dal=new DB_TeleBill.DAL.m_Role();
		public m_Role()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_TeleBill.Model.m_Role model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_TeleBill.Model.m_Role model)
		{
			return Update(model,"");
		}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_TeleBill.Model.m_Role> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_TeleBill.Model.m_Role> GetModelListSql(string strSql)
        {
