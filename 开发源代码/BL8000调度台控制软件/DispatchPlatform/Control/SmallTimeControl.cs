...
{
    public partial class SmallTimeControl : UserControl
    {
        public SmallTimeControl()
        {
            InitializeComponent();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            labelX2.Text = DateTime.Now.ToString("HH:mm:ss");
            labelX1.Text = DateTime.Now.ToString("yyyy-MM-dd");
        }
    }
}
