...
{
    public class GroupCallCommand : BaseCommand
    {
       // public int Number { get; set; }
        ...
        public override bool Begin()
        {
           ...
           // RaiseOnMsg("正在创建会议");
            ...
            return TalkSDK.MBOX_GroupCall(base.talkControl.handle, base.talkControl.CurrentDispatchNumber, lst.ToArray(), base.talkControl.NumberList.Count);
