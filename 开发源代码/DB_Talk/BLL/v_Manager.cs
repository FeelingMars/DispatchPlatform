...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.v_Manager dal=new DB_Talk.DAL.v_Manager();
		public v_Manager()
		{}
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.v_Manager> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.v_Manager> GetModelListSql(string strSql)
        {
