...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.m_SIPInterface dal=new DB_Talk.DAL.m_SIPInterface();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_Talk.Model.m_SIPInterface model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_Talk.Model.m_SIPInterface model)
		{
			return Update(model,"");
		}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_SIPInterface> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.m_SIPInterface> GetModelListSql(string strSql)
        {
