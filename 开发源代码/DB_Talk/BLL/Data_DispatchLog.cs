...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.Data_DispatchLog dal=new DB_Talk.DAL.Data_DispatchLog();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_Talk.Model.Data_DispatchLog model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_Talk.Model.Data_DispatchLog model)
		{
			return Update(model,"");
		}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.Data_DispatchLog> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.Data_DispatchLog> GetModelListSql(string strSql)
        {
        ...
        public List<DB_Talk.Model.Data_DispatchLog> GetModelListByCount(int Top, string strWhere, string filedOrder)
        {
            return dal.DataTableToList(dal.GetList(Top, strWhere, filedOrder));
        }
