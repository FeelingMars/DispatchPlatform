...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.m_PRIChannel dal=new DB_Talk.DAL.m_PRIChannel();
		public m_PRIChannel()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_Talk.Model.m_PRIChannel model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_Talk.Model.m_PRIChannel model)
		{
			return Update(model,"");
		}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_PRIChannel> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.m_PRIChannel> GetModelListSql(string strSql)
        {
