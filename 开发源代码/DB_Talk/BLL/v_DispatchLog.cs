...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.v_DispatchLog dal=new DB_Talk.DAL.v_DispatchLog();
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.v_DispatchLog> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.v_DispatchLog> GetModelListSql(string strSql)
        {
