...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.m_Departments dal=new DB_Talk.DAL.m_Departments();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_Talk.Model.m_Departments model)
		{
       ...
       /// <summary>
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_Talk.Model.m_Departments GetModel(int ID)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_Departments> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.m_Departments> GetModelListSql(string strSql)
        {
