...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.m_Member dal=new DB_Talk.DAL.m_Member();
		public m_Member()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_Talk.Model.m_Member model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_Talk.Model.m_Member model)
		{
			return Update(model,"");
		}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_Member> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.m_Member> GetModelListSql(string strSql)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<DB_Talk.Model.m_Member> GetModelListEX(string strWhere)
        {
            DataSet ds = GetListEX(strWhere);
            return dal.DataTableToListEX(ds);
        }
