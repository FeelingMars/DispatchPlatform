...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.v_SystemLog dal=new DB_Talk.DAL.v_SystemLog();
		public v_SystemLog()
		{}
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.v_SystemLog> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.v_SystemLog> GetModelListSql(string strSql)
        {
