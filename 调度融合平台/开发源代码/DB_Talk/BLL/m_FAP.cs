...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.m_FAP dal=new DB_Talk.DAL.m_FAP();
		public m_FAP()
		{}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_FAP> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.m_FAP> GetModelListSql(string strSql)
        {
