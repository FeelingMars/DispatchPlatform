...
namespace DB_Talk.BLL
{
	...
	{
		private readonly DB_Talk.DAL.m_Camera dal=new DB_Talk.DAL.m_Camera();
		public m_Camera()
		{}
		#region  Method
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_Camera> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_Camera> DataTableToList(DataTable dt)
		{
			List<DB_Talk.Model.m_Camera> modelList = new List<DB_Talk.Model.m_Camera>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DB_Talk.Model.m_Camera model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new DB_Talk.Model.m_Camera();
