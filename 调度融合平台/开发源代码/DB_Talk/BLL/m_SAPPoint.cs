...
namespace DB_Talk.BLL 
{
	...
	/// m_SAPPoint
	/// </summary>	
	public partial class m_SAPPoint
	{    
		private readonly DB_Talk.DAL.m_SAPPoint dal=new DB_Talk.DAL.m_SAPPoint();
		public m_SAPPoint()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_Talk.Model.m_SAPPoint model)
		{
		...
		/// 增加一条数据,并返回ID
		/// </summary>
		public int  Add(DB_Talk.Model.m_SAPPoint model,bool IsReturnID)   
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_Talk.Model.m_SAPPoint model)
		{
			return Update(model,"");
		}
		...
		/// 根据条件更新数据
		/// </summary>
		public bool Update(DB_Talk.Model.m_SAPPoint model,string strWhere)
		{
       ...
       /// <summary>
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_Talk.Model.m_SAPPoint GetModel(int ID)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.m_SAPPoint> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.m_SAPPoint> GetModelListSql(string strSql)
        {
