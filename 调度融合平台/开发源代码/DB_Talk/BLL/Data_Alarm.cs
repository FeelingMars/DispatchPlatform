...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.Data_Alarm dal=new DB_Talk.DAL.Data_Alarm();
		public Data_Alarm()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(DB_Talk.Model.Data_Alarm model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_Talk.Model.Data_Alarm model)
		{
			return Update(model,"");
		}
       ...
       /// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.Data_Alarm> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.Data_Alarm> GetModelListSql(string strSql)
        {
