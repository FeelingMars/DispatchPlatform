...
namespace DB_Talk.BLL 
{
	...
	{    
		private readonly DB_Talk.DAL.v_Data_Alarm dal=new DB_Talk.DAL.v_Data_Alarm();
		public v_Data_Alarm()
		{}
		...
		/// 获得数据列表
		/// </summary>
		public List<DB_Talk.Model.v_Data_Alarm> GetModelList(string strWhere)
		{
		...
		/// 执行sql语句，获取实体列表
		/// </summary>
        public List<DB_Talk.Model.v_Data_Alarm> GetModelListSql(string strSql)
        {
